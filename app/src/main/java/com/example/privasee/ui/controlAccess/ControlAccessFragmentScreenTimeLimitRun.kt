...
import kotlinx.android.synthetic.main.fragment_control_access_screentimelimit_run.*
import java.io.File


class ControlAccessFragmentScreenTimeLimitRun : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_control_access_screentimelimit_run, container, false)
